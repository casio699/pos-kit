...
let DashboardController = class DashboardController {
    ...
    async getDashboard(req) {
        ...
        return this.reportingService.getDashboardStats(tenant_id);
    }
    async getSalesSummary(req) {
        const tenant_id = req.user.tenant_id;
        return this.reportingService.getSalesSummary(tenant_id);
    }
    async getInventorySummary(req) {
        const tenant_id = req.user.tenant_id;
        return this.reportingService.getInventorySummary(tenant_id);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getSalesSummary", null);
__decorate([
